...
public class VentanaNombreDeUsuario extends JDialog {
	...
	protected static Humano jugador;
	...
	private void initialize() {
		setIconImage(
				Toolkit.getDefaultToolkit().getImage(VentanaNombreDeUsuario.class.getResource("/resources/radar.png")));
				...
				btnAceptar.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						if (gettxtNombre().getText().equals("")) {
							...
							jugador = new Humano(gettxtNombre().getText());
